...
class User(Base):
    ...
    grades: Mapped[list["Grade"]] = relationship(
        "Grade", foreign_keys="Grade.student_id", back_populates="student"
    )
    grades_user: Mapped[list["Grade"]] = relationship(
        "Grade", foreign_keys="Grade.added_by_id", back_populates="teacher"
    )
    attendance_user: Mapped[list["Attendance"]] = relationship(
        "Attendance", foreign_keys="Attendance.added_by_id", back_populates="teacher"
    )
    attendances: Mapped[list["Attendance"]] = relationship(
        "Attendance", foreign_keys="Attendance.student_id", back_populates="student"
    )
...
class Subject(Base):
    ...
    attendances: Mapped[list["Attendance"]] = relationship(
        "Attendance", back_populates="subject"
    )
...
class Grade(Base):
    ...
    student: Mapped["User"] = relationship(
        "User", foreign_keys=[student_id], back_populates="grades"
    )
    teacher: Mapped["User"] = relationship(
        "User", foreign_keys=[added_by_id], back_populates="grades_user"
    )
...
class Attendance(Base):
    ...
    student: Mapped["User"] = relationship(
        "User", foreign_keys=[student_id], back_populates="attendances"
    )
    teacher: Mapped["User"] = relationship(
        "User", foreign_keys=[added_by_id], back_populates="attendance_user"
    )
